# Generated by Django 4.2.5 on 2024-08-27 19:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('tier', models.CharField(choices=[('platinum', 'platinum'), ('gold', 'gold'), ('silver', 'silver'), ('individual', 'individual')], max_length=20)),
